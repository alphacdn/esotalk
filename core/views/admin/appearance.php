...
<li><span><i class='fa fa-user'></i><?php printf(T("By %s"), "<a href='{$skin["info"]["authorURL"]}'>{$skin["info"]["author"]}</a>"); ?></span></li>
<li class='sep'></li>
<?php if (!$skin["selectedMobile"]): ?><li><a href='<?php echo URL("admin/appearance/activateMobile/$k?token=".ET::$session->token); ?>'><i class='fa fa-mobile'></i><?php echo T("Use for mobile"); ?></a></li><?php endif; ?>
<li><a href='<?php echo URL("admin/appearance/uninstall/$k?token=".ET::$session->token); ?>'><i class='fa fa-trash-o'></i><?php echo T("Uninstall"); ?></a></li>
</ul>
...
<?php if ($skin["selectedMobile"]): ?><i class='fa fa-mobile' title='<?php echo T("Mobile skin"); ?>'></i><?php endif; ?>
