...
<a href='<?php echo URL(searchURL("#".T("gambit.author:").$member["username"])); ?>' class='control-search'><i class='fa fa-search'></i></a>
</div></li>

<li><label><?php echo T("Conversations participated in"); ?></label> <div>
<?php echo number_format($statistics["conversationsParticipated"]); ?>
<a href='<?php echo URL(searchURL("#".T("gambit.contributor:").$member["username"])); ?>' class='control-search'><i class='fa fa-search'></i></a>
</div></li>
