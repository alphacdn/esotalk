...
<a href='<?php echo URL("conversation/changeChannel/".$conversation["conversationId"]); ?>' id='control-changeChannel'><i class='fa fa-tag'></i> <?php echo T("Change channel"); ?></a>
...
<a href='#membersAllowedSheet' id='control-changeMembersAllowed'><i class='fa fa-pencil'></i> <?php echo T("Change"); ?></a>
</div>
