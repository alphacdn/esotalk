...
$footer = "<div class='editButtons'>".
	...
	"<a href='".URL("conversation/discard/".$conversation["conversationId"]."?token=".ET::$session->token)."' class='button big discardDraft' title='".T("Discard")."'><i class='fa fa-trash'></i></a> ".
